...
func (d *MDNS) Run(ctx context.Context, host host.Host) error {
	// setup mDNS discovery to find local peers

	if d.c == nil {
		d.c = log.Logger("cred/mDNS")
	}

	disc := mdns.NewMdnsService(host, d.DiscoveryServiceTag, &discoveryNotifee{h: host, c: d.c})
	return disc.Start()
}

//func startMdns(cxt context.Context,host host.Host)  {
//
//	_ = m.Run(a.ctx, p2pHost)
//}
